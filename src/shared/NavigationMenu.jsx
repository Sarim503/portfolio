...
export default function NavigationMenuDemo() {
  ...
  <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3">
    ...
    <Link href="/" className="flex items-center gap-2">
      <Avatar className="cursor-pointer w-10 h-10 text-primary font-bold border-2 border-primary transition-transform hover:scale-110">
    ...
    {/* Navigation Menu */}
   <NavigationMenu>
  <NavigationMenuList className="flex gap-x-8 text-sm font-medium text-foreground">
